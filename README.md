...
- setItem(item: TItemElement, inBasket: boolean): void; - подготавливает `container`, на основе разметки карточки товара и информации о наличии товара в корзине
...
- `success:submit` - закрытие модального окна с информацией о результате отправки заказа на сервер по его главной кнопке, а в случае неудачной отправки - повторная попытка
